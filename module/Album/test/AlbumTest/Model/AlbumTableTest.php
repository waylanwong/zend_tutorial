...
class AlbumTableTest extends PHPUnit_Framework_TestCase {
    public function testFetchAllReturnsAllAlbums() {
        ...
        $mockTableGateway -> expects($this -> once()) -> method('select') -> with() -> will($this -> returnValue($resultSet));
    ...
    public function testCanRetrieveAnAlbumByItsId() {
        $album = new Album();
        $album -> exchangeArray(array('id' => 123, 'artist' => 'The Military Wives', 'title' => 'In My Dreams'));
    ...
    public function testCanDeleteAnAlbumByItsId() {
        ...
        $mockTableGateway -> expects($this -> once()) -> method('delete') -> with(array('id' => 123));
    ...
    public function testSaveAlbumWillInsertNewAlbumsIfTheyDontAlreadyHaveAnId() {
        ...
        $mockTableGateway -> expects($this -> once()) -> method('insert') -> with($albumData);
